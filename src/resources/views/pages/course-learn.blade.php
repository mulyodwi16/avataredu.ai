                ...
                <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="text-xs text-white/80 mt-2 text-center">
                            {{ $completedLessons }} of {{ $totalLessons }} {{ $totalLessons == 1 ? 'item' : 'lessons' }} completed
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach($chapter->lessons as $lesson)
                                        ...
                                        <div class="group flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-200
                                            ...
                                            <div class="flex-shrink-0">
                                                @if($isCompleted)
                                                    <div class="w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    @elseif($course->main_video_url)
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 shadow-md">
                                    <!-- Enhanced Completion Icon -->
                                    <div class="flex-shrink-0">
                                        @if($isCompleted)
                                            <div class="w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="font-semibold text-gray-900 truncate">{{ $course->video_title ?? 'Course Video' }}</div>
                                        <div class="inline-flex items-center gap-1 text-xs text-blue-600 bg-blue-50 px-2 py-1 rounded-full mt-1">
                                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path>
                                            </svg>
                                            Video Content
                ...
                <div id="lesson-content" class="p-4 lg:p-8">
                    @if($course->chapters->flatMap->lessons->count() > 0)
                        ...
                        @if($currentLesson)
                                    ...
                                    <div class="grid gap-3">
                                        @foreach($currentLesson->attachments as $attachment)
                                            <a href="{{ $attachment['url'] ?? '#' }}" target="_blank"
                                               class="flex items-center gap-4 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 group">
                                                <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd"></path>
                                                    </svg>
                                                </div>
                                                <span class="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">{{ $attachment['name'] ?? 'Download' }}</span>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col lg:flex-row justify-between items-center gap-6 bg-white rounded-2xl shadow-sm border border-gray-200 p-6 lg:p-8">
                                @php
                                ...
                                <div class="flex gap-3 w-full lg:w-auto">
                                    ...
                                    @if($prevLesson)
                                        <button onclick="loadLesson({{ $prevLesson->id }})"
                                            class="flex-1 lg:flex-none px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 font-semibold">
                                            ← Previous
                                        </button>
                                    @endif
                    ...
                    @else
                        ...
                        @else
                            ...
                            <div class="text-center py-20">
                                ...
                                <div class="mt-8">
                                    <a href="{{ route('dashboard') }}" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200">
                                        Return to Dashboard
                                    </a>
                                </div>
                            </div>
