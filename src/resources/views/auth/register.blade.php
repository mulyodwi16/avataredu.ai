...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-white to-white px-4">
  <div class="w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2">
    ...
    <div class="p-8 md:p-12 flex flex-col justify-center">
      <h2 class="text-3xl font-bold text-primary mb-6">Create Account</h2>
      <p class="text-gray-600 mb-6">Join Avataredu.ai and start your learning journey today.</p>
      ...
      <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <button type="submit"
          class="w-full bg-primary hover:bg-primaryDark text-white font-semibold py-2 rounded-lg">
          Sign Up
        </button>
      </form>
      ...
      {{-- Tombol Sign up dengan Google (UI) --}}
    ...
    <div class="hidden md:flex items-center justify-center bg-gradient-to-br from-primary to-accent">
      <img src="https://via.placeholder.com/400x400.png?text=Register+Illustration"
           alt="Register illustration" class="max-h-80">
    </div>
  </div>
</div>
@endsection