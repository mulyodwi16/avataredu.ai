...
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form id="createPageForm" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">This will be used to create the page URL slug</p>
            </div>
            ...
            <div>
                ...
                <div id="editor-container" class="border border-t-0 border-gray-300 rounded-b-lg bg-white p-4 min-h-64"
                    contenteditable="true" style="outline: none;"></div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p class="text-sm text-blue-700">
                    <strong>Note:</strong> Halaman ini akan otomatis mengikuti status publish dari course yang dipilih.
                    Jika course publish, maka halaman ini juga publish.
                </p>
            </div>
...
<script>
    ...
    document.getElementById('createPageForm').addEventListener('submit', function (e) {
        ...
        fetch('/admin/pages', {
            ...
            .then(data => {
                if (data.success) {
                    alert(data.message || 'Page created successfully!');
                    if (data.redirect) {
                        loadAdminPage('pages');
                    }
                } else {
